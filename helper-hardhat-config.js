...
const feeCollectorAddress = process.env.FEE_COLLECTOR_ADDRESS || "0x0000000000000000000000000000000000000000";

const tokenCreationFeeConfig = process.env.TOKEN_CREATION_FEE || "0.0001"; // Default 0.05 ETH
const launchFeeConfig = process.env.LAUNCH_FEE || "0.0001"; // Default 0.1 ETH
